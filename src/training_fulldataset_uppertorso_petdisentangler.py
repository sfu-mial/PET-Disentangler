...
train_files = healthy[:460]+disease[:352]
val_files = healthy[460:518]+disease[352:395]
test_files = healthy[518:]+disease[395:]

# # PSEUDO-HEALTHY MODEL:
train_ds_healthy = Dataset(data=healthy[:460], transform=draft_transforms)
train_ds_disease = Dataset(data=disease[:352], transform=draft_transforms)

val_ds = Dataset(data=healthy[460:518] + disease[352:395], transform=draft_transforms)
